...
import (
	...
	"github.com/hawkingrei/dt-dns/src/core"
	"github.com/hawkingrei/dt-dns/src/servers"
	"github.com/hawkingrei/dt-dns/src/utils"
)

var logger = logging.MustGetLogger("dtdns.main")
