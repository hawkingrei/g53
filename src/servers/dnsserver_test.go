...
func TestDNSResponse(t *testing.T) {
	...
	//server.AddService("www.duitang.net", Service{Record_type: "CNAME", TTL: 600 , Value: "www.cctv.com",Aliases: "www.duitang.net"})
	server.AddService("www.1d1u1i1t1a1n1g1.net.", Service{Record_type: "A", TTL: 600, Value: "127.0.0.1", Aliases: "www.1d1u1i1t1a1n1g1.net."})
	server.AddService("foo.duitang.net.", Service{Record_type: "A", TTL: 600, Value: "127.0.0.1", Aliases: "foo.duitang.net."})
...
func TestServiceManagement(t *testing.T) {
	...
	A := Service{Aliases: "bar.duitang.com.", Record_type: "A", TTL: 3600, Value: "127.0.0.1"}
	...
	list.AddService("boo.duitang.com.", Service{Aliases: "boo.duitang.com.", TTL: 3600, Record_type: "A", Value: "127.0.0.1"})
	...
	list.AddService("416261e74515b7dd1dbd55f35e8625b063044f6ddf74907269e07e9f142bc0df", Service{Aliases: "mysql.duitang.net.", Record_type: "A", Value: "127.0.0.1"})
